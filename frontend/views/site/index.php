...
<div class="row">
	<div class="col-md-3">
		<div class="input-group">
			<input id="filter-date" type="text" data-initial="<?= Yii::$app->request->get('begin')?>" value="" class="form-control" placeholder="Дата события" readonly>
	...
	<div class="col-md-3">
		<div class="input-group">
			<span class="input-group-btn">
				<span class="btn  trigger" style="<?= !Yii::$app->request->get('search')?'display:none':''?>"><i  id="filter-search-clear" class="md-clear"></i></span>
				<span class="btn"><i  id="filter-date-clear" class="md-search"></i></span>
			</span>
			<input id=filter-search type="text" class="form-control" placeholder="Поиск" value="<?= Yii::$app->request->get('search')?>" >
		</div>
	</div>
</div>
<br/>
<div class="row">
	<div id="events-list-empty" class="event-list-empty  text-muted" style="display:none; text-align: center;font-size: 20px;">
		События не найдены
	</div>
