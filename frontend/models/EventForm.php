...
class EventForm extends Model
{
    ...
    /**
     * Устанавливаем существующую модель - ебаный метод который очень плохо организован,
     * но так как из за него придётся переписывать не только саму модель но и шаблон то решил его не трогать.
     * @param Event $event
     */
     ...
     *       afterInsert - Да я то вообще бы это обрал в спед события по крону
     */
